        ...
        <>
            <div className=' container mt-5'>
                ...
                <div className='row  p-3 mt-5 text-center '>
                    <div className='col  '>
                        <img className=" universe-images " src='media/zerodhaFundhouse.png'></img>
                    ...
                    <div className='col   '>
                        <img className="universe-images" src='media/sensibullLogo.svg'></img>
                    ...
                    <div className='col  '>
                        <img className=" universe-images " src='media/tijori.svg'></img>
                ...
                <div className='row  p-3 text-center '>
                    ...
                    <div className='col   '>
                        <img className="universe-images" src='media/streakLogo.png'></img>
                        <p className='mt-1 text-muted p-2' style={{ fontSize: "0.8rem" }}>Systematic trading platform <br />
                            that allows you to create and backtest<br />
                            strategies without coding.</p>
                    </div>
                    <div className='col   '>
                        <img className="universe-images" src='media/smallcaseLogo.png'></img>
                    ...
                    <div className='col   '>
                        <img className="universe-images" src='media/dittoLogo.png'></img>
                ...
                <div className='row text-center'>
                                        <button className=' p-2  mx-auto mt-3 signup-Btn '>Sign up for free</button>
                </div>
